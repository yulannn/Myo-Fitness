...
import { PlusIcon, TrashIcon, ArrowLeftIcon, ArrowRightIcon, ClipboardDocumentListIcon, ArrowsRightLeftIcon } from '@heroicons/react/24/outline';
...
export const ManualProgramModal = ({
    ...
    const handleExerciseSelect = (exerciseId: number) => {
        ...
        setSessions(newSessions);
        // Modal closes automatically, but we update state to reflect closed
        // setModalState({ ...modalState, isOpen: false }); <- actually handled by onClose prop
    };
