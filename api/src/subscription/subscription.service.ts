    ...
    const subscription = await this.prisma.subscription.create({
      data: {
        ...
        trialStartDate: createSubscriptionDto.trialStartDate
          ? new Date(createSubscriptionDto.trialStartDate)
          : null,
    ...
    const updated = await this.prisma.subscription.update({
      ...
      data: {
        ...
        endDate: updateSubscriptionDto.endDate
          ...
          : undefined,
        trialStartDate: updateSubscriptionDto.trialStartDate
          ? new Date(updateSubscriptionDto.trialStartDate)
          : undefined,
        trialEndDate: updateSubscriptionDto.trialEndDate
          ? new Date(updateSubscriptionDto.trialEndDate)
          : undefined,
        cancelledAt: updateSubscriptionDto.cancelledAt
