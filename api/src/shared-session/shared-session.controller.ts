...
export class SharedSessionController {
  ...
  create(
    @Request() req,
    @Body() createSharedSessionDto: CreateSharedSessionDto,
  ) {
    return this.sharedSessionService.create(
      req.user.userId,
  ...
  inviteGroup(
    ...
    return this.sharedSessionService.inviteGroup(
      req.user.userId,
      id,
      body.groupId,
    );
  ...
  inviteFriend(
    ...
    return this.sharedSessionService.inviteFriend(
      req.user.userId,
      id,
      body.friendId,
    );
