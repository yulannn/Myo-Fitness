...
export class TrainingSessionEntity {
  ...
  @ApiPropertyOptional({ description: 'Date de création', example: '2025-10-22T12:00:00.000Z' })
  createdAt?: Date;

  @ApiPropertyOptional({ description: 'Date de dernière mise à jour', example: '2025-10-22T12:00:00.000Z' })
  updatedAt?: Date;
}
